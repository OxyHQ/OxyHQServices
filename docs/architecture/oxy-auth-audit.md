...
- [~] **2c PR3 (cutover cero-cookies + migración IdP) — DRAFT, gateado por telemetría** — borra deviceAuth/oxy_device/cookieKeyHash/converge/refresh family + cold boot v3 final + docs 7bis. Versiones (sin publicar hasta merge): contracts 0.13.0, core 9.0.0, services 19.0.0. Criterio de merge: CloudWatch Insights `mint_source: cookie ≈ 0` sostenido 48-72h tras el rollout de apps con SDK ≥8.1.0/18.1.0 **Y** IdP migrado ✅.

...
import { StyleSheet, ScrollView, View, Text, Clipboard } from 'react-native';
import { useOxy } from '@oxyhq/services';
import { ThemedText, ThemedView, Section, GroupedSection, Button, Badge, EmptyState } from '@/components';
    ...
    <ThemedView style={styles.container}>
      ...
      {!isAuthenticated ? (
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
          {apps.map((app) => (
            <Section key={app.id} title={app.name}>
              <GroupedSection
                items={[
                  {
                    id: `${app.id}-status`,

...
Non commercial use is free. Commercial use requires a paid licence; the trigger is revenue and it includes internal use. Source publication and attribution are required of everyone, including paying customers, and cannot be waived. Cooperatives, nonprofits, educational institutions, public bodies and worker owned businesses pay no fee. This is **source available, not open source**.

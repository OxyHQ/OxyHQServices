...
export const LogoIcon: React.FC<LogoIconProps> = ({ 
  ...
  // In dark mode: outer/main parts should be black, accent should be theme primary
  // In light mode: outer/main parts should be white, accent should be theme primary
  const primaryColor = color !== undefined 
    ? color 
    : (isDark ? '#000000' : '#fefefe');
  const accentColor = secondaryColor !== undefined
    ? secondaryColor
    : (theme?.colors?.primary || '#d169e5');

  return (
    <Svg viewBox="0 0 294.84 174.42" width={width} height={height} style={style}>
      {/* Path 1 - cls-2 (white) - outer shape */}
      <Path
      ...
      <Path
        ...
        fill={primaryColor}
      />
      {/* Path 5 - cls-1 (purple/pink) - detail */}
      <Path

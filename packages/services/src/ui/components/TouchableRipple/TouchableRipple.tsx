...
const SettingsContext = React.createContext({ rippleEffectEnabled: true });
...
const TouchableRipple = (
  ...
  const { rippleEffectEnabled } = React.useContext(SettingsContext) as { rippleEffectEnabled: boolean };

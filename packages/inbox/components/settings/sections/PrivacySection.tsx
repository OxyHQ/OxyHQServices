...
const NOOP = () => {
  // No-op stub for the disabled switches — wired once server-backed
  // privacy preferences ship. Each row's protection is already enabled
  // by default at the network layer.
};
    ...
    <View style={styles.root}>
      ...
      <View style={styles.subsection}>
        ...
        <Text style={[styles.body, { color: colors.secondaryText }]}>
          Oxy follows a privacy-by-default posture: senders never see your IP, location, or read receipts, and tracking pixels are blocked at the network edge. We'll surface granular per-message and per-sender overrides as the protections mature.
        </Text>
      </View>
    </View>
  );

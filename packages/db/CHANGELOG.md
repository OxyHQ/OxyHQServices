...
**Nothing here is retroactive, and it could not be.** `@oxyhq/db@0.1.0` was
published under AGPL-3.0-only and stays AGPL-3.0-only forever for anyone who
...
you, pinning `0.1.0` remains lawful and always will.
